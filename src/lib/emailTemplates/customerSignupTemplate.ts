export function createCustomerSignupEmailTemplate(confirmationLink: string, email: string): string {
    return `
<!DOCTYPE html>
<html lang="cs">
<head>
    ...
    <div class="container">
        ...
        <div class="content">
            <p class="welcome-text">
                Dobrý den,<br><br>
                děkujeme za registraci do Šťastné srdce. Pro dokončení registrace prosím potvrďte svůj email kliknutím na tlačítko níže.
            </p>
            ...
            <div class="info-box">
                ...
                <p><strong>Typ účtu:</strong> Zákazník</p>
