...
<main>
  <div
    class="py-8 py-16 px-4 mx-auto max-w-screen-lg mt-20 bg-stone-100 rounded-lg footer_fix mb-10"
  >
    <h1
      ...
      <div class="place-items-center text-lg">
        ...
        {#each cartItems as cartItem, i (cartItem._id)}
          <div class="mb-5 bg-stone-100 border-2 rounded-lg">
            ...
            <div class="mb-5 font-light p-8 col-span-4">
    ...
    <div
      class="p-4 mx-auto max-w-screen-xl rounded-lg border-2 hidden md:grid bg-orange-50"
    >
          ...
          >
            ...
            >
              ...
              >
                ...
                <div data-te-modal-body-ref class="relative p-4">Opravdu chcete potvrdit košík a odeslat?</div>
                <div
                  class="flex flex-shrink-0 flex-wrap items-center justify-end rounded-b-md border-t-2 border-neutral-100 border-opacity-100 p-4 dark:border-opacity-50"
                >
                  <button
                    type="button"
                    class="btn btn-success py-2 px-4 bg-green-600 hover:bg-green-700 focus:ring-green-500 f ocus:ring-offset-green-200 text-white transition ease-in duration-200 text-center shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg mr-2"
                    data-te-modal-dismiss
                    data-te-ripple-init
                    data-te-ripple-color="light"
                  >
                  ...
                  >
									  <a
                      activeClass={$page.url.pathname === "/thankyou"}
                      href="/thankyou">Odeslat</a
                    >      										         
                  </button>
                </div>
              </div>
