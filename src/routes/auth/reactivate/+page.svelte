<script lang="ts">
	...
	let { profile, token, isValid, daysRemaining, alreadyReactivated, justReactivated } = data;
	$: ({ profile, token, isValid, daysRemaining, alreadyReactivated, justReactivated } = data);
</script>
				...
				<div class="flex">
					...
					<div class="ml-3">
						<h3 class="text-sm font-medium text-green-800">
							🎉 Účet byl úspěšně reaktivován!
						</h3>
						<p class="mt-2 text-sm text-green-700">
							Vaše žádost o smazání dat byla <strong>zrušena</strong>. Můžete se nyní 
							<a href="/login" class="underline font-medium">přihlásit</a> a používat náš systém jako obvykle.
						</p>
						<div class="mt-3 text-sm text-green-700">
							<p><strong>Co se obnovilo:</strong></p>
		...
		{:else if alreadyReactivated}
			<div class="bg-green-50 border border-green-200 rounded-lg p-4">
				<div class="flex">
					...
					<div class="ml-3">
						<h3 class="text-sm font-medium text-green-800">
							✅ Účet již byl reaktivován
						</h3>
						<p class="mt-2 text-sm text-green-700">
							Váš účet byl úspěšně reaktivován. Můžete se nyní 
							<a href="/login" class="underline font-medium">přihlásit</a> jako obvykle.
						</p>
					</div>
				</div>
			</div>
