    ...
    <form on:submit|preventDefault={resetPass}>   
        <div class="pt-20 form-widget">                  
           <!--  <img
									...
									src="/"
									alt="1" /> -->
              <div class="mt-20 mx-auto flex flex-col w-full max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
                <div class="self-center mb-4 text-3xl sm:text-2xl font-light text-gray-800 sm:text-2xl dark:text-white">Nové heslo</div>
