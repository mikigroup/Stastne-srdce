    ...
    <form on:submit|preventDefault={forgotPass}>   
        <div class="pt-20 form-widget">                  
           <!--  <img
									...
									src="/"
									alt="1" /> -->
              <div class="flex flex-col w-full max-w-md px-4 py-8 mx-auto mt-20 bg-white rounded-lg shadow h-80 sm:px-6 md:px-8 lg:px-10">
                <div class="self-center mb-4 text-3xl font-light text-gray-800 sm:text-2xl">Zapomenuté heslo</div>
                <div class="flex w-full text-xl">
                  <span class="inline-flex items-center px-3 text-sm text-gray-500 bg-white border-t border-b border-l border-gray-300 shadow-sm rounded-l-md">
                    ...
                    <input class="flex-1 w-full px-4 py-2 text-base text-gray-700 placeholder-gray-400 bg-white border border-gray-300 rounded-r-lg shadow-sm appearance-none form-control focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-transparent" name="email" type="email" label="Email address" placeholder="Zadej svoji mailovou adresu" icon="mail" bind:value={email} required/>
                </div>
                <div class="flex w-full my-4">
                <button {loading} 
                id="btn-success" type="submit" class="w-full px-4 py-2 text-base font-semibold text-center text-white transition duration-200 ease-in bg-green-600 rounded-lg shadow-md btn btn-success hover:bg-green-700 focus:ring-green-500 focus:ring-offset-green-200 focus:outline-none focus:ring-2 focus:ring-offset-2 ">
                    Reset hesla
                </button>
                </div>                            
                 {#if message}
