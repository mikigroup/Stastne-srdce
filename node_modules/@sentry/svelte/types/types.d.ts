 ...
 */
export declare type SvelteConfig = {
    [key: string]: unknown;
 ...
 */
export declare type SentrySvelteConfigOptions = {
    componentTracking?: ComponentTrackingInitOptions;
};
export declare type SpanOptions = {
    /**
 ...
 */
export declare type ComponentTrackingInitOptions = {
    /**
...
export declare type TrackComponentOptions = {
