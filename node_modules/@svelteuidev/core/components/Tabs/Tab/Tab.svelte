<script>import useStyles from './Tab.styles';
import { ctx } from '../Tabs.svelte';
import { Box } from '../../Box';
import { getContext, onMount } from 'svelte';
export let use = [], element = undefined, className = '', override = {}, active = undefined, icon = undefined, label = undefined, color = undefined, variant = undefined, orientation = undefined, tabKey = undefined;
