...
declare const _default: (params?: AlertStylesParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"content" | "icon" | "root" | "title" | "label" | "message" | "closeButton" | "wrapper">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"content" | "icon" | "root" | "title" | "label" | "message" | "closeButton" | "wrapper", string>;
